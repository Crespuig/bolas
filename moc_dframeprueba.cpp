...
void WidgetLineas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WidgetLineas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WidgetLineas::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_WidgetLineas.data,
    qt_meta_data_WidgetLineas,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject DFramePrueba::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_DFramePrueba.data,
    qt_meta_data_DFramePrueba,
    qt_static_metacall,
    nullptr,
    nullptr
} };
