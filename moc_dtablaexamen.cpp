...
QT_INIT_METAOBJECT const QMetaObject DTablaExamen::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_DTablaExamen.data,
    qt_meta_data_DTablaExamen,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void ModeloTablaExamen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ModeloTablaExamen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ModeloTablaExamen::staticMetaObject = { {
    &QAbstractTableModel::staticMetaObject,
    qt_meta_stringdata_ModeloTablaExamen.data,
    qt_meta_data_ModeloTablaExamen,
    qt_static_metacall,
    nullptr,
    nullptr
} };
