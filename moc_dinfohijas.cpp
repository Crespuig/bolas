...
void DInfoHijas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DInfoHijas *_t = static_cast<DInfoHijas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DInfoHijas::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DInfoHijas.data,
      qt_meta_data_DInfoHijas,  qt_static_metacall, nullptr, nullptr}
};
